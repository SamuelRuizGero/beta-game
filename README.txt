...
NOTE: You can find where you downloaded the repo by going to your cmd and typing "start ." this will open the
folder that contains the files you downloaded from Github.

Steps if you're using MAC:
1.
